...
public class TabButton extends ImageButton {
    ...
    public TabButton(int x, int y, int width, int height, int textureX, int textureY, ResourceLocation texture, OnPress onPress) {
    ...
    public TabButton(int x, int y, int width, int height, int textureX, int textureY, int textureYOffset, ResourceLocation texture, OnPress onPress) {
    ...
    public TabButton(int x, int y, int width, int height, int textureX, int textureY, int textureYOffset, ResourceLocation texture, int textureWidth, int textureHeight, OnPress onPress) {
    ...
    public TabButton(int x, int y, int width, int height, int textureX, int textureY, int textureYOffset, ResourceLocation texture, int textureWidth, int textureHeight, OnPress onPress, Component message) {
    ...
    public TabButton(int x, int y, int width, int height, int textureYOffset, ResourceLocation texture, Rect2i normalTextureRect, Rect2i selectedTextureRect, OnTabPress onTabPress, Component message) {
    ...
    public TabButton(int x, int y, int width, int height, int textureYOffset, ResourceLocation normalTexture, Rect2i normalTextureRect, ResourceLocation selectedTexture, Rect2i selectedTextureRect, OnTabPress onTabPress, Component message) {
